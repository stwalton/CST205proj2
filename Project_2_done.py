...
# Form implementation generated from reading ui file 'Project_2_done.ui'
#
...
class Ui_MoneyApp(object):
    ...
    def retranslateUi(self, MoneyApp):
        ...
        self.final_text1.setText(_translate("MoneyApp", "This is only used as a reference"))
        self.final_text2.setText(_translate("MoneyApp", "This is only used as a reference"))
        self.final_text3.setText(_translate("MoneyApp", "This is only used as a reference"))
        self.final_text4.setText(_translate("MoneyApp", "TextLabel"))
