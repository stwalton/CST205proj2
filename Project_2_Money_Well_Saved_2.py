...
#3-16-2017
#CST 205
#GitHub: https://github.com/stwalton/CST205proj2


from PyQt5 import QtCore, QtGui, QtWidgets

#Steven code -> the gui interface
class Ui_MoneyApp(object):
    def setupUi(self, MoneyApp):
        ...
        #Below is code that I forgot to remove. Don't want to remove know as I don't want to jinq's this program
        ...
        #This is where the input bar and text you see on screen are intialized.
    def retranslateUi(self, MoneyApp):
        ...
        #Text for self.text_3. Also start of other calculation that determines how long you want to save by income instead of full amount per day
        self.text_3.setText(_translate("MoneyApp", "3. 3-5 is a different calculation. This doesnt require a date."))
...
# The def calculate was a mixture of Niccollo and Steven
# Steven code is all the variables and the set.final_text.
# Nicollo worked on the calculations, and Steven help contribute to the Juilian day formula
...
#This code is what loads the gui
