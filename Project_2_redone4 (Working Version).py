...
class Ui_MoneyApp(object):
    ...
    def calendar(self, select_date):
        ...
        cal_day = (select_date.day())#store the day from the calendar
        cal_month = (select_date.month()) #stores the month from the calendar
        cal_year = (select_date.year()) #stores the year from the calendar
        print(cal_day)
        print(cal_month)
        print(cal_year)
