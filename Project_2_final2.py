...
class Ui_MoneyApp(object):
    def setupUi(self, MoneyApp):
        self.cal_day = 0; #Gets the day when you click the calendar
        self.cal_month = 0; #Gets the month when you click the calendar
        self.cal_year = 0; #Gets the year when you click the calendar
    ...
    def calculate(self):
        ...
        print(self.cal_day)
        print(self.cal_month)
        print(self.cal_year)
        
        tax = (self.percent_value.value()) #Tax variable/value
        save = (self.save_value.toPlainText()) #save variable/value
        start_amount = (self.startmn_value.toPlainText()) #start amount variable/value
        paycheck = (self.paycheck_value.toPlainText()) #paycheck amount variable/value
        print(tax)
        print(save)
        print(start_amount)
        print(paycheck)

        cur_d = QtCore.QDate.currentDate()
        cur_day = (cur_d.day())
