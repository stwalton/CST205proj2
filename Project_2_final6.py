...
class Ui_MoneyApp(object):
    def setupUi(self, MoneyApp):
        ...
        self.calculation1 = 0 #Intializes the first calculation that will be printed
        self.calculation2 = 0 #Intializes the second calculation that will be printed
        ...
        self.final_text2.setGeometry(QtCore.QRect(10, 570, 291, 20))
    ...
    def calculate(self):
        ...
        self.tax = int(self.percent_value.value()) #Tax variable/value
        self.save = int(self.save_value.toPlainText()) #save variable/value
        self.start_amount = int(self.startmn_value.toPlainText()) #start amount variable/value
        self.paycheck = int(self.paycheck_value.toPlainText()) #paycheck amount variable/value
        ...
        quick_math2 = self.paycheck * self.tax
        ...
        calculation2_string = "With your weekly income at " + str(self.paycheck) + " with " + str(self.tax) + "% going toward savings," 
